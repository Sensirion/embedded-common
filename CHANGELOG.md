 ...
 * [`renamed`] `sensirion_i2c_hal_release()` to `sensirion_i2c_hal_free()'.
 * [`renamed`] `sensirion_uart_hal_open()` to `sensirion_uart_hal_init()'.
 * [`renamed`] `sensirion_uart_hal_close()` to `sensirion_uart_hal_free()'.
