...
TEST (EmbeddedCommon_SHDLC_Tests, Frame_Test_1) {
    uint8_t outdata[] = {0x7E, 0x00, 0x80, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7A, 0x7E};
    uint8_t buffer[11];
    ...
    sensirion_shdlc_begin_frame(&frame, &buffer[0],command,address,data_length);
...
TEST (EmbeddedCommon_SHDLC_Tests, Frame_Test_2) {
    uint8_t outdata[] = {0x7E, 0x00, 0x80, 0x05, 0x00, 0x01, 0x02, 0x03, 0x04, 0x70, 0x7E};
    uint8_t buffer[11];
...
TEST (EmbeddedCommon_SHDLC_Tests, Frame_Test_3) {
    uint8_t outdata[] = {0x7E, 0x00, 0x80, 0x05, 0x00, 0x7D, 0x5E, 0x7D, 0x5D, 0x7D, 0x31, 0x7D, 0x33, 0x5B, 0x7E};
    uint8_t buffer[15];
